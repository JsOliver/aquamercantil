                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="home-wrapper home-wrapper-alt p-1">
                            ...
                            <h4 class="text-light" style="text-shadow: 1px 1px 5px #ffffff; color:#141f3d;"><b>Somos a primeira empresa especializada na comercialização de pescado por meio de leilão no Brasil. Com base no sistema adotado pelas cooperativas de produtores de flores em Holambra - VEILING® HOLAMBRA, criamos a Aqua Mercantil um sistema de Leilão Reverso On Line. Uma ferramenta para facilitar o comércio de pescados e aproximar o seu produto do mercado.</b></h4>
...
<div class="container" id="leiloes">
   ...
   $iniciodatas = $dds['data_inicio'];
    ...
    <br>
                    ...
                    if(!isset($_SESSION['ID'])):
                    ?><br>
                        <div style="font-size: 10pt;text-decoration: none;float: left;margin-top: -2%;"><b>Especie: </b><?php echo $dds['nome_cientifico_br']; ?> &nbsp;&nbsp;&nbsp;</div><br>
                        ...
                        <div style="font-size: 10pt;text-decoration: none;float: left;margin-top: -2%;"><b>
                                ...
                                <?php if($dds['classificacao'] == 'Processado Congelado' or $dds['classificacao'] == 'Processado Fresco'): echo 'Peso individual:' ; else:  echo 'Peso Médio:'; endif;?> </b> <?php echo $dds['peso_individual']; ?></div>
...
<section class="section" id="gqualidade">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="feat-description text-center">
                            <h4 class="text-muted">•	Transparência e igualdade nas negociações;<br>

                                •	Produtos frescos com menos custos operacionais;<br>
                                •	Novo conceito na comercialização de pescados baseado na oferta e procura;<br>
                                •	Assessoria em marketing e promoção de vendas;<br>
                                •	Atuação em todos os segmentos do mercado;<br>
                                •	Garantia de qualidade;<br>
                                •	Garantia de pagamento;<br>
                                •	Ampla carteira de clientes;<br>
                                •	Controle na padronização dos produtos;<br>
                                •	Informação do mercado para auxílio das decisões;<br>
                            </h4>
    ...
    <section>
        <div class="row margin-0 wide-img-showcase-row">
            ...
            <div class="col-sm-6"  style="background: #2f3e47;">
                <div class="about-detail-img-box" >
                        ...
                        <div class="col-sm-12">
                            <div class="text-center">
                                <div class="title-box-icon title-about text-white">
                                    <h3 class="title">
                                        GARANTIA DE QUALIDADE AQUAMERCANTIL
                                    </h3>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-sm-offset-6 no-padding img-2 " style="background-image: url(http://s2.glbimg.com/9q7NiQ2TtjEoJTr1-TYi3Ex-KnE=/780x440/e.glbimg.com/og/ed/f/original/2015/12/10/peixes-pesca-pescaria-piscultura-bill-bredley.jpg);">
            </div>
