...
<head>
  ...
  $('#ccemb').mask("99 99 99 99", {placeholder:"xx xx xx xx"});
...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo base_url('admin');?>">Painel do administrador</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url('admin/inicio');?>"><i class="fa fa-dashboard fa-fw"></i> Resumo</a>
                    </li>

                    <li>
                        <a href="<?php echo base_url('admin/leiloes');?>"><i class="fa fa-table fa-fw"></i> Leilões</a>
                    </li>
                    <li>
